...
#else
#define MCP2515_DEFAULT_CS_PIN          9
...
public:
  ...
  void sendPacket(uint8_t* message,int id, int dlc = -1, bool rtr = false);
  void sendExtendedPacket(uint8_t* message,long id, int dlc = -1, bool rtr = false);
